...
@AllArgsConstructor
@Entity
@Table(name = "Handball49WinsMarginSeasonInfo",  uniqueConstraints = { @UniqueConstraint(name = "UniqueSeasonAndCompetitionForTeamWM", columnNames = { "teamID", "season", "competition" }) })
public class Handball49WinsMarginSeasonInfo extends StatsBySeasonInfo {
